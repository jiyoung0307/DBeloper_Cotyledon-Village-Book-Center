...
public class DBeloper_Member_View {
	...
	public void member_View() {
		...
		/* 로그인시 멤버의 정보 중 필요한 것만 Member DTO에 받아온다. */
	...
	/* 본인 작성 리뷰를 조회하기 위해 회원 번호를 넘겨주기 위한 메소드 */
	...
	/* 리뷰를 조회하고 싶은 책의 도서 번호를 입력하는 메소드 */
	...
	/* 회원정보 조회 메소드(본인 정보 조회) -> controller로 넘어갈 필요없이 로그인시 받아온 데이터로 처리함 */
	...
	/* 마일리지로 상품 구매 (마일리지 사용) - NullPointerException 오류로 if문으로 처리 */
